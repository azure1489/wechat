...
func TestGetFriendAndChatRoomList(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	friendAndChatRooms, err := NewWechat(ip, port, url).GetFriendAndChatRoomList(url)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestSendTextMsg(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	err := NewWechat(ip, port, url).SendTextMsg("filehelper", "123123123")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestStickyChat(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	err := NewWechat(ip, port, url).StickyChat("filehelper")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestUnpinChat(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	err := NewWechat(ip, port, url).UnpinChat("filehelper")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestSendPicMsg(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	err := NewWechat(ip, port, url).SendPicMsg("filehelper", "", "1.png")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestConfigureMsgRecive(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	err := NewWechat(ip, port, url).ConfigureMsgRecive(1, "")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestQueryBodyInfo(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	info, err := NewWechat(ip, port, url).QueryBodyInfo("filehelper")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestGetFriendOrChatroomDetailInfo(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	info, err := NewWechat(ip, port, url).GetFriendOrChatroomDetailInfo("filehelper")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestGetUnReadMsgNum(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	info, err := NewWechat(ip, port, url).GetUnReadMsgNum()
	if err != nil {
		t.Error(err)
		return
	}
...
func TestEditFriendMark(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	err := NewWechat(ip, port, url).EditFriendMark("", "test2")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestTimelineGetFristPage(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	info, err := NewWechat(ip, port, url).TimelineGetFristPage(url)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestGetFriendTimeline(t *testing.T) {
	...
	ip := "10.211.4.239"
	port := "30001"
	info, err := NewWechat(ip, port, url).GetFriendTimeline("xiaoming709959")
	if err != nil {
		t.Error(err)
		return
	}
